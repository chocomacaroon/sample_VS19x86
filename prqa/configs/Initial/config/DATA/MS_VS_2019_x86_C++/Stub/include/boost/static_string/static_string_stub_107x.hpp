...
#ifndef QACPP_BOOST_STATIC_STRING_STATIC_STRING_HPP
#define QACPP_BOOST_STATIC_STRING_STATIC_STRING_HPP
...
public:
  ...
  */
  ...
  insert(
    const_iterator pos,
    ForwardIterator first,
    ForwardIterator last) -> typename std::enable_if<
    detail::is_forward_iterator<
  ...
  */
  ...
  replace(
    ...
    const_iterator i2,
    InputIterator j1,
    InputIterator j2) -> typename std::enable_if<
    detail::is_input_iterator<
      InputIterator>::value &&
        !detail::is_forward_iterator<
          InputIterator>::value,
  ...
  replace(
    ...
    const_iterator i2,
    ForwardIterator j1,
    ForwardIterator j2) -> typename std::enable_if<
    detail::is_forward_iterator<
      ForwardIterator>::value,
        basic_static_string<N, CharT, Traits>&>::type;
#endif
